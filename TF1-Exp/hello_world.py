...
flags = tf.app.flags
flags.DEFINE_string('demo', 'nn_example', 'which demo to run')
...
def nn_example():
    mnist = input_data.read_data_sets('mnist_workspace/', one_hot=True)
...
def main(_):
    if FLAGS.demo == 'simple':
        run_simple_graph()
    elif FLAGS.demo == 'simple_mul':
        run_simple_graph_multiple()
    elif FLAGS.demo == 'nn_example':
        nn_example()
